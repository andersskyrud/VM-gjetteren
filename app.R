  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      wellPanel(
        ...
        tags$ol(
          tags$li("Mål trekkes for hvert lag fra en Poisson-fordeling – ",
          "antall mål ett lag scorer påvirker ikke det andre"),
          tags$li("Forventet mål i en jevn kamp (τ₀) settes av brukeren og ",
          "antas likt for alle kamper, uavhengig av hvilke lag som møtes. "),
          tags$li("Ingen hjemmebanefordel, siden VM spilles på nøytral bane. "),
          tags$li("Målene utledes direkte fra FIFA-poeng. Med andre ord modelleres ikke ",
          ...
          "kamp."),
          tags$li("Utregninga antar også at det skåres flere mål i ujevne kamper. Jo større ",
